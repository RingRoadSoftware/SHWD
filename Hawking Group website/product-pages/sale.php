...
<body style="min-width: 980px;">
    ...
    <div class="home-welcome-text" style="height: 380px; ">
        ...
        <div class="image-content" style="margin: 0 auto; width: 85%; height: 100%; padding: 10px;">
            <img src="../images/WH1000Xm4.jpg" align="left" style="display: block; margin-left: auto; margin-right: auto;">
            <div class="info" style="width: 65%; margin-left: 9%;">
                <p style="color: black; font-size: 20px; text-align: justify;">It’s just you and your music with the
                    WH-1000XM4 headphones. The easy way to enjoy less noise and even purer sound, with smart listening
                    technology that automatically personalises your experience.</p>
            </div>
            <div class="purchase-info"><form  method="post" action="../cart.php?action=add&code=9">
